...
public class OrderQueryConstants {
    ...
    public static final String GET_SUM_PAYMENT = "SELECT SUM(PAYMENT_AMOUNT) AS total FROM order ";
    ...
    public static final String UPDATE_ORDER_BY_ID = "UPDATE order SET LICENSE_PLATES = '%s',SELLER = '%s',BUYER = '%s',TOTAL_WEIGHT = '%s',VEHICLE_WEIGHT = '%s',CARGO_WEIGHT = '%s',UPDATED_AT = '%s',STATUS = '%s',PAYMENT_STATUS = '%s',CARGO_TYPE = '%s',PAYMENT_AMOUNT = '%s',NOTE = '%s',PAYER = '%s' " +
            "WHERE ID = '%s'";
    public static final String UPDATE_ORDER_STATUS_BY_ID = "UPDATE order SET STATUS = '%s' WHERE ID = '%s'";
}
